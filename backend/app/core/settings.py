...
class Settings(BaseSettings):
    ...
    max_risk_per_trade: float = Field(default=0.0075, gt=0, le=0.05)
    max_total_open_risk: float = Field(default=0.05, gt=0, le=0.25)
    max_margin_per_trade: float = Field(default=0.15, gt=0, le=1)
    max_total_margin: float = Field(default=0.50, gt=0, le=1)
    ...
    max_portfolio_exposure: float = Field(default=1.00, gt=0, le=3)
